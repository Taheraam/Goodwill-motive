      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-card rounded-3xl p-6 shadow-sm">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-bold text-[#40916C] uppercase tracking-wider">Humanitarian Ledger</span>
          </div>
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#D8F3DC] text-xs font-bold text-[#1B4332]">
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-xl shadow-[#1B4332]/10 glass-card">
        ...
        <div className="relative p-6 sm:p-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <p className="text-[#D8F3DC]/90 text-xs font-bold uppercase tracking-wider">Your Personal Impact</p>
          </div>
          <div className="grid grid-cols-3 gap-4 sm:gap-6">
            {[
              { icon: <LeafIcon size={24} />, value: personalMeals, label: 'Meals Funded', color: 'text-[#9FD4B4]' },
              ...
              <div key={i} className="text-center glass-strong rounded-2xl p-4 sm:p-5 border border-white/10">
                ...
                <p className="text-2xl sm:text-4xl font-display font-bold text-white tracking-tight">{item.value.toLocaleString()}</p>
      ...
      <div className="space-y-4">
        ...
        {loading ? (
          ...
          <div className="glass-card rounded-3xl p-10 text-center">
            ...
            <p className="text-xs text-[#40916C]/70 mt-1">New humanitarian initiatives are being reviewed and will launch shortly.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="glass-card rounded-3xl p-6 border border-[rgba(64,145,108,0.15)] flex flex-col sm:flex-row items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-[#40916C]/70 mt-1 leading-relaxed font-medium">
            Every meal, tree planted, and educational grant is transparently tracked. All impact allocations are verifiable and audited.
          </p>
        </div>
      </div>
    </div>
