  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8 stagger-children">
        ...
        <h1 className="text-3xl font-display font-bold text-[#1B4332]">Welcome back</h1>
        <p className="text-[#40916C]/70 mt-2">Continue your contribution journey</p>
      </div>
      ...
      <div className="glass-card rounded-3xl p-8 space-y-5 animate-fade-in-scale">
        ...
        <p className="text-center text-sm text-[#40916C]/70">
          ...
          <Link href="/signup" className="text-[#40916C] font-semibold hover:text-[#1B4332] transition-colors">
            Create account
          </Link>
        </p>
      </div>
      ...
      <div className="mt-5 text-center animate-fade-in-up">
        <Link href="/admin/login" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full border border-[#40916C]/20 text-xs font-medium text-[#40916C]/60 hover:text-[#40916C] hover:border-[#40916C]/40 transition-all">
          <ShieldIcon size={12} />
          Admin Portal
